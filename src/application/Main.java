...
// ************************************************************************************************************************************************************************			
			...
			menuItem_añadir_cancion.setOnAction(e -> {
				 ...
				 */
				anadir_canciones(primaryStage, vol);
			});
...
// ************************************************************************************************************************************************************************
	...
	private void cerrar_programa(Stage primaryStage) {
		primaryStage.close();
	}

	private void anadir_canciones(Stage primaryStage, Slider vol) {
	...
	public void metodo_adelantar() {
		uno.stop();
		uno= new Control(canciones_escogidas.proxima_cancion());
		Lista_Vi.selectionModelProperty().get().select(canciones_escogidas.getId());
		uno.play();
		listado_canciones.setText(canciones_escogidas.nom_prox_cancion().getName());
	}

	public void metodo_atrasar() {
		
			uno.stop();
			uno = new Control(canciones_escogidas.cancion_atras());
			Lista_Vi.selectionModelProperty().get().select(canciones_escogidas.getId());
			uno.play();
			listado_canciones.setText(canciones_escogidas.nom_atras_cancion().getName());
